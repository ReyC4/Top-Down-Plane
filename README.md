<p align="center">
  <img width="100%" alt="prostir" src="https://github.com/user-attachments/assets/ff23cb43-b329-43dd-8ccb-e672eeda8912">
  </br>
</p>
...
## ▶️ Video Gameplay
<img src="https://github.com/ReyC4/ReyC4/blob/main/GIF/TopD.gif" alt="1" style="width:50%;height:auto;">
...
| `Camera.cs` | Handles camera to follow ships in the game. |
| `Player_Movement.cs`  | Controls the player movement. |
| `Enemy_Movement.cs`  | Manage enemy movement in game. |
| `etc`  | |
...
```
├── Top Down                      # In this Folder, containing all the Unity project files, to be opened by a Unity Editor
   ├── ...
   ├── Assets                         #  In this Folder, it contains all our code, assets, scenes, etcwas not automatically created by Unity
      ├── ...
      ├── Mini Pixel Pack                   # In this folder, there are several packages that you must add via Unity Package Manager
